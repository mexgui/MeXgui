...
namespace MeXgui
{
	...
	const QString &VideoCodec::getID() const
	{
		return id;
	}

	VideoCodec::VideoCodec(const QString &id)
	{
		this->id = id;
	}
...
VideoCodec *const VideoCodec::MPEG2 = new VideoCodec("MPEG2");
	...
	const QString &AudioCodec::getID() const
	{
		return id;
	}

	AudioCodec::AudioCodec(const QString &id)
	{
		this->id = id;
	}
...
AudioCodec *const AudioCodec::OPUS = new AudioCodec("OPUS");
	...
	const QString &SubtitleCodec::getID() const
	{
		return id;
	}

	SubtitleCodec::SubtitleCodec(const QString &id)
	{
		this->id = id;
	}
...
SubtitleCodec *const SubtitleCodec::IMAGE = new SubtitleCodec("IMAGE");
	...
	const QString &VideoEncoderType::getID() const
	{
		return id;
	}

	VideoEncoderType::VideoEncoderType(const QString &id, VideoCodec *codec)
	{
		this->id = id;
		this->codec = codec;
	}

	QString VideoEncoderType::ToString()
	{
		return getID();
	}
...
VideoEncoderType *const VideoEncoderType::HFYU = new VideoEncoderType("Huffyuv", VideoCodec::HFYU);
	...
	const QString &AudioEncoderType::getID() const
	{
		return id;
	}

	AudioEncoderType::AudioEncoderType(const QString &id, AudioCodec *codec)
	{
		this->id = id;
		this->codec = codec;
	}
...
GenericRegisterer<AudioEncoderType*> *CodecManager::AudioEncoderTypes = new GenericRegisterer<AudioEncoderType*>();
	...
	VideoType::VideoType(const QString &name, const QString &filterName, const QString &extension, MeXgui::ContainerType *containerType, VideoCodec *supportedCodec)
	{
	}

	VideoType::VideoType(const QString &name, const QString &filterName, const QString &extension, MeXgui::ContainerType *containerType, VideoCodec supportedCodecs[]) : OutputType(name, filterName, extension, containerType)
	{
...
VideoType *const VideoType::M2TS = new VideoType("M2TS", "M2TS Files", "m2ts", getContainerType()->M2TS, new VideoCodec[] {VideoCodec::AVC, VideoCodec::MPEG2, VideoCodec::VC1});
	...
	AudioType::AudioType(const QString &name, const QString &filterName, const QString &extension, MeXgui::ContainerType *containerType, AudioCodec *supportedCodec)
	{
	}

	AudioType::AudioType(const QString &name, const QString &filterName, const QString &extension, MeXgui::ContainerType *containerType, AudioCodec supportedCodecs[]) : OutputType(name, filterName, extension, containerType)
	{
			this->supportedCodecs = supportedCodecs;
	}
...
AudioType *const AudioType::OPUS = new AudioType("OPUS", "Opus Audio Files", "opus", 0, AudioCodec::OPUS);
	...
	SubtitleType::SubtitleType(const QString &name, const QString &filterName, const QString &extension, MeXgui::ContainerType *containerType) : OutputType(name, filterName, extension, containerType)
	{
	}
...
SubtitleType *const SubtitleType::TTXT = new SubtitleType("TTXT", "Time Text Subtitles Files", "ttxt", 0);
	...
	ChapterType::ChapterType(const QString &name, const QString &filterName, const QString &extension, MeXgui::ContainerType *containerType) : OutputType(name, filterName, extension, containerType)
	{
	}
...
ChapterType *const ChapterType::MKV_XML = new ChapterType("Matroska Chapter", "Matroska Chapter Files", "xml", 0);
	...
	DeviceType::DeviceType(const QString &name, const QString &filterName, const QString &extension, MeXgui::ContainerType *containerType) : OutputType(name, filterName, extension, containerType)
	{
	}
...
DeviceType *const DeviceType::PC = new DeviceType("PC", "PC", "PC", getContainerType()->AVI);
	...
	ContainerType::ContainerType(const QString &name, const QString &filterName, const QString &extension) : OutputFileType(name, filterName, extension)
	{
	}
...
const ContainerType ContainerType::Containers[4] = {MP4, MKV, AVI, M2TS};
	...
	ContainerType *ContainerType::ByName(const QString &id)
	{
		for (MeXgui::ContainerType::const_iterator t = Containers->begin(); t != Containers->end(); ++t)
			if ((*t)->getID() == id)
				return t;
		return 0;
	}
...
GenericRegisterer<DeviceType*> *ContainerManager::DeviceTypes = new GenericRegisterer<DeviceType*>();
	...
	OutputFileType::OutputFileType(const QString &name, const QString &filterName, const QString &extension)
	{
		this->name = name;
	...
	const QString &OutputFileType::getID() const
	{
		return name;
	}

	QString OutputFileType::ToString()
	{
		return this->name;
	}

	const QString &OutputFileType::getOutputFilter() const
	{
		return "*." + extension;
	}

	const QString &OutputFileType::getOutputFilterString() const
	{
		return filterName + " (*." + extension + ")|*." + extension;
	}

	const QString &OutputFileType::getExtension() const
	{
		return this->extension;
	}

	OutputType::OutputType(const QString &name, const QString &filterName, const QString &extension, MeXgui::ContainerType *containerType) : OutputFileType(name, filterName, extension)
	{
		this->containerType = containerType;
	}

	const MeXgui::ContainerType &OutputType::getContainerType() const
	{
