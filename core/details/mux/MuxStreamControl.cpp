	...
	namespace core
	{
		namespace details
		{
			namespace mux
			{
				...
				const MeXgui::core::details::MuxStream &MuxStreamControl::getStream() const
				{
				...
				const QString &MuxStreamControl::getFilter() const
				{
					return input->getFilter();
				}

				void MuxStreamControl::setFilter(const QString &value)
				{
					input->setFilter(value);
				}

				void MuxStreamControl::SetLanguage(const QString &lang)
				{
				...
				void MuxStreamControl::removeSubtitleTrack_Click()
				{
					input->Text = "";
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'EndsWith' method:
				...
				void MuxStreamControl::chkForceStream_CheckedChanged()
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'TrimEnd' method:
				...
				void MuxStreamControl::InitializeComponent()
				{
					...
					this->input->setTitle("");
					this->input->FileSelected += new MeXgui::FileBarEventHandler(this, &MuxStreamControl::input_FileSelected);
					// 
					// chkDefaultStream
					// 
