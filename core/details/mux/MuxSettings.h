...
namespace MeXgui
{
	...
	{
	private:
		QVector<MuxStream*> audioStreams, subtitleStreams;
		Nullable<decimal> framerate;
		QString chapterFile, videoName;
		QString muxedInput, videoInput, muxedOutput, deviceType;
		bool muxAll;
		Nullable<Dar> dar;
	...
	public:
		...
		const QString &getMuxedInput() const;
		void setMuxedInput(const QString &value);

		const QString &getMuxedOutput() const;
		void setMuxedOutput(const QString &value);
		...
		/// </summary>
		const QVector<MuxStream*> &getAudioStreams() const;
		void setAudioStreams(const QVector<MuxStream*> &value);

		/// <summary>
		/// Array of subtitle tracks to be muxed
		/// </summary>
		const QVector<MuxStream*> &getSubtitleStreams() const;
		void setSubtitleStreams(const QVector<MuxStream*> &value);
