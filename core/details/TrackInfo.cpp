...
namespace MeXgui
{
	...
	TrackInfo::TrackInfo(const QString &language, const QString &name)
	{
	...
	const MeXgui::TrackType &TrackInfo::getTrackType() const
	{
		return _trackType;
	}

	void TrackInfo::setTrackType(const MeXgui::TrackType &value)
	{
		_trackType = value;
	}

	const QString &TrackInfo::getLanguage() const
	{
		return _language;
	}

	void TrackInfo::setLanguage(const QString &value)
	{
		_language = value;
	}

	const QString &TrackInfo::getSourceFileName() const
	{
		return _sourceFileName;
	}

	void TrackInfo::setSourceFileName(const QString &value)
	{
		_sourceFileName = value;
	}

	const QString &TrackInfo::getName() const
	{
		return _name;
	}

	void TrackInfo::setName(const QString &value)
	{
		_name = value;
	}
	...
	const QString &TrackInfo::getContainerType() const
	{
		return _containerType;
	}

	void TrackInfo::setContainerType(const QString &value)
	{
	...
	const QString &TrackInfo::getCodec() const
	{
		return _codec;
	}

	void TrackInfo::setCodec(const QString &value)
	{
		_codec = value;
	}
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'Trim' method:
	...
	const QString &TrackInfo::getDemuxFileName() const
	{
