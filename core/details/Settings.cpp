...
namespace MeXgui
{
	...
	MeXguiSettings::MeXguiSettings()
	{
		...
		autoscroll = true;
		autoUpdateServerLists = new QString[][] {new QString[] {"Stable", "http://org/auto/stable/", "http://xvidvideo.ru/auto/stable/"}, new QString[] {"Development", "http://org/auto/", "http://xvidvideo.ru/auto/"}, new QString[] {"Custom"}};
	...
	const QString &*MeXguiSettings::getAutoUpdateServerLists() const
	{
		...
		{
			autoUpdateServerLists[0] = new QString[] {"Stable", "http://org/auto/stable/", "http://xvidvideo.ru/auto/stable/"};
			autoUpdateServerLists[1] = new QString[] {"Development", "http://org/auto/", "http://xvidvideo.ru/auto/"};
		}
		else
		{
			autoUpdateServerLists = new QString[][] {new QString[] {"Stable", "http://org/auto/stable/", "http://xvidvideo.ru/auto/stable/"}, new QString[] {"Development", "http://org/auto/", "http://xvidvideo.ru/auto/"}, new QString[] {"Custom"}};
	...
	#if defined(x64)
		autoUpdateServerLists = new QString[][] {new QString[] {"Stable", "http://org/auto/", "http://xvidvideo.ru/auto/"}, new QString[] {"Development", "http://org/auto/", "http://xvidvideo.ru/auto/"}, new QString[] {"Custom", "http://org/auto/", "http://xvidvideo.ru/auto/"}};
	#endif
	#if defined(DEBUG)
		autoUpdateServerLists = new QString[][] {new QString[] {"Stable", "http://org/auto/"}, new QString[] {"Development", "http://org/auto/"}, new QString[] {"Custom", "http://org/auto/"}};
	#endif
