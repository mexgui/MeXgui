...
namespace MeXgui
{
	namespace core
	{
		namespace gui
		{
			...
			{
				workerNameAndJob->Text = QString::Format("{0}: {1}", w->getName(), w->getStatusString());
				progressBar1->Value = static_cast<int>(w->getProgress());
			}

			void IndividualWorkerSummary::startEncodingToolStripMenuItem_Click(QObject *sender, QEvent *e)
			{
				w->StartEncoding(true);
				RefreshInfo();
			}

			void IndividualWorkerSummary::abortToolStripMenuItem_Click(QObject *sender, QEvent *e)
			{
				w->UserRequestedAbort();
			}

			void IndividualWorkerSummary::renameToolStripMenuItem_Click(QObject *sender, QEvent *e)
			{
				w->UserRequestedRename();
			}

			void IndividualWorkerSummary::stopToolStripMenuItem_Click(QObject *sender, QEvent *e)
			{
			...
			void IndividualWorkerSummary::shutDownToolStripMenuItem_Click(QObject *sender, QEvent *e)
			{
				w->UserRequestShutDown();
			}

			void IndividualWorkerSummary::shutDownLaterToolStripMenuItem_Click(QObject *sender, QEvent *e)
			{
				w->ShutDownWhenFinished();
			}

			void IndividualWorkerSummary::showProgressWindowToolStripMenuItem_Click(QObject *sender, QEvent *e)
			{
			...
			void IndividualWorkerSummary::showQueueToolStripMenuItem_Click(QObject *sender, QEvent *e)
			{
			...
			void IndividualWorkerSummary::contextMenuStrip1_Opening(QObject *sender, CancelQEvent *e)
			{
