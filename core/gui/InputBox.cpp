...
namespace MeGUI
{
	namespace core
	{
		namespace gui
		{
			...
			void InputBox::btnOk_Click(QObject *sender, QEvent *e)
			{
				DialogResult = System::Windows::Forms::DialogResult::OK;
				Close();
			}

			void InputBox::btnCancel_Click(QObject *sender, QEvent *e)
			{
				DialogResult = System::Windows::Forms::DialogResult::Cancel;
				Close();
			}

			QString InputBox::Show(const QString &message, const QString &title, const QString &defaultText)
			{
...
//				using (InputBox box = new InputBox())
				...
				try
				{
					...
					box->Text = title;
					if (box->show() == System::Windows::Forms::DialogResult::OK)
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to the exception 'finally' clause:
			...
			void InputBox::text_KeyPress(QObject *sender, KeyPressQEvent *e)
			{
				if (e->KeyChar == 13)
				{
					btnOk_Click(0, 0);
