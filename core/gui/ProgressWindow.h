...
namespace MeGUI
{
	...
	typedef void (*UpdateStatusCallback)(StatusUpdate *su); // delegate for UpdateStatus event
	typedef void (*PriorityChangedCallback)(ProcessPriority priority); // delegate for PriorityChanged event
...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
	...
	private:
		QString getTimeString(TimeSpan *span, decimal percentageDone);
	...
	public:
		...
		/// <param name="e"></param>
	private:
		void abortButton_Click(QObject *sender, System::QEvent *e);
		/// <summary>Handles changes in the priority dropdwon</summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void priority_SelectedIndexChanged(QObject *sender, System::QEvent *e);
