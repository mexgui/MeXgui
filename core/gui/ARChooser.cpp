...
const QString ARChooser::Later = "Auto-detect later";
...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
				StandardAndCustomComboBox::Getter = delegate
				{
					...
					if (AspectRatioChooser::show(tempVar::HasValue ? tempVar : Dar::ITU16x9PAL, result) == DialogResult::OK)
						return result;
					else
						return 0;
				};
			...
			void ARChooser::setHasLater(const bool &value)
			{
				...
				if (hasLater)
				{
					QVector<object*> o = QVector<object*>();
					o.push_back(Later);
					o.AddRange(ARs);
