...
namespace MeXgui
{
	...
	void ZonesControl::zoneMode_SelectedIndexChanged(QObject *sender, System::QEvent *e)
	{
	...
	void ZonesControl::removeZoneButton_Click(QObject *sender, System::QEvent *e)
	{
	...
	void ZonesControl::clearZonesButton_Click(QObject *sender, System::QEvent *e)
	{
	...
	void ZonesControl::addZoneButton_Click(QObject *sender, System::QEvent *e)
	{
		...
		else
		{
			...
			for (MeXgui::Zone::const_iterator z = zones->begin(); z != zones->end(); ++z)
			{
				...
				{
					QString errorMessage = "The new zone intersects with an existing zone:\nstart:" + (*z)->startFrame + " end: " + (*z)->endFrame;
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
	...
	void ZonesControl::zoneListView_SelectedIndexChanged(QObject *sender, System::QEvent *e)
	{
	...
	void ZonesControl::updateZoneButton_Click(QObject *sender, System::QEvent *e)
	{
	...
	void ZonesControl::player_Closed(QObject *sender, QEvent *e)
	{
//C# TO C++ CONVERTER WARNING: C# to C++ Converter converted the original 'null' assignment to a call to 'delete', but you should review memory allocation of all pointer variables in the converted code:
		delete player;
	}

	void ZonesControl::showVideoButton_Click(QObject *sender, System::QEvent *e)
	{
	...
	void ZonesControl::setInput(const QString &value)
	{
		input = value;
		showVideoButton->Enabled = !value.empty();
	}

	const QString &ZonesControl::getInput() const
	{
		return input;
	}
	...
	void ZonesControl::ZonesControl_Load(QObject *sender, QEvent *e)
	{
		zoneMode->SelectedIndex = 0;
	}
