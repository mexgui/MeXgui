...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
			...
			const QString &NiceComboBox::getSelectedText() const
			{
			...
			void NiceComboBox::dropDownButton_Click(QObject *sender, QEvent *e)
			{
			...
			ToolStripItem *NiceComboBox::createMenu(QVector<NiceComboBoxItem*> &items)
			{
			...
			void NiceComboBox::item_Click(QObject *sender, QEvent *e)
			{
			...
			NiceComboBoxItem::NiceComboBoxItem(const QString &name, object *tag)
			{
				Name = name;
				Tag = tag;
			}
			...
			{
				ItemClicked(this, new QEvent());
			}

			NiceComboBoxNormalItem::NiceComboBoxNormalItem(const QString &name, object *tag) : NiceComboBoxItem(name,tag)
			{
				InitializeInstanceFields();
			}

			NiceComboBoxNormalItem::NiceComboBoxNormalItem(const QString &name, object *tag, NiceComboBoxItemClicked handler)
			{
				InitializeInstanceFields();
				ItemClicked += handler;
				Selectable = false;
			...
			NiceComboBoxSubMenuItem::NiceComboBoxSubMenuItem(const QString &name, object *tag, ...) : NiceComboBoxItem(name, tag)
			{
				SubItems = QVector<NiceComboBoxItem*>(subItems);
			}
