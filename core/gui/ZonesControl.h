...
//C# TO C++ CONVERTER WARNING: Since the array size is not known in this declaration, C# to C++ Converter has converted this array to a pointer.  You will need to call 'delete[]' where appropriate:
		...
		void zoneMode_SelectedIndexChanged(QObject *sender, System::QEvent *e);

		void removeZoneButton_Click(QObject *sender, System::QEvent *e);

		void clearZonesButton_Click(QObject *sender, System::QEvent *e);
		void addZoneButton_Click(QObject *sender, System::QEvent *e);
		/// <summary>
		...
		void zoneListView_SelectedIndexChanged(QObject *sender, System::QEvent *e);
		void updateZoneButton_Click(QObject *sender, System::QEvent *e);
		/// <summary>
		...
		/// </summary>
		void player_Closed(QObject *sender, QEvent *e);
		void showVideoButton_Click(QObject *sender, System::QEvent *e);
		/// <summary>
	...
	private:
		void ZonesControl_Load(QObject *sender, QEvent *e);
