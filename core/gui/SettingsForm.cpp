...
namespace MeGUI
{
	...
	SettingsForm::SettingsForm()
	{
		...
		InitializeComponent();
		QVector<QString> keys = QVector<QString>(LanguageSelectionContainer::getLanguages().Keys);
	...
	QString SettingsForm::SelectHelpText(const QString &node)
	{
		StringBuilder *HelpText = new StringBuilder(64);

		QString xpath = "/ContextHelp/Form[@name='SettingsForm']/" + node;
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
	...
	void SettingsForm::configSourceDetector_Click(QObject *sender, QEvent *e)
	{
		SourceDetectorConfigWindow *sdcWindow = new SourceDetectorConfigWindow();
		sdcWindow->setSettings(sdSettings);
		if (sdcWindow->show() == System::Windows::Forms::DialogResult::OK)
			sdSettings = sdcWindow->getSettings();
	}

	void SettingsForm::resetDialogs_Click(QObject *sender, QEvent *e)
	{
	...
	void SettingsForm::runCommand_CheckedChanged(QObject *sender, QEvent *e)
	{
		command->Enabled = runCommand->Checked;
	}

	void SettingsForm::autoEncodeDefaultsButton_Click(QObject *sender, QEvent *e)
	{
...
//		using (MeGUI.core.gui.AutoUpdateServerConfigWindow w = new MeGUI.core.gui.AutoUpdateServerConfigWindow())
		...
		try
		{
			...
			if (w->show() == System::Windows::Forms::DialogResult::OK)
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to the exception 'finally' clause:
	...
	void SettingsForm::cbHttpProxyMode_SelectedIndexChanged(QObject *sender, QEvent *e)
	{
	...
	void SettingsForm::clearDefaultOutputDir_Click(QObject *sender, QEvent *e)
	{
	...
	void SettingsForm::backupfiles_CheckedChanged(QObject *sender, QEvent *e)
	{
...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
	...
	void SettingsForm::btnClearMP4TempDirectory_Click(QObject *sender, QEvent *e)
	{
		tempDirMP4->setFilename("");
	}

	void SettingsForm::btnClearOutputDirecoty_Click(QObject *sender, QEvent *e)
	{
		defaultOutputDir->setFilename("");
	}

	void SettingsForm::tempDirMP4_FileSelected(FileBar *sender, FileBarQEvent *args)
	{
	...
	void SettingsForm::useNeroAacEnc_CheckedChanged(QObject *sender, QEvent *e)
	{
