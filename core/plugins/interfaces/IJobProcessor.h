...
namespace MeXgui
{
	...
	public:
		...
		JobPreProcessor(Processor p, const QString &id);
	};
	...
	public:
		...
		JobPostProcessor(Processor p, const QString &id);
	};
	...
	public:
		...
		JobProcessorFactory(ProcessorFactory factory, const QString &id);
	};
