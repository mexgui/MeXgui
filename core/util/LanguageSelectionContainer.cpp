...
namespace MeXgui
{
	...
	const QMap<QString, QString> &LanguageSelectionContainer::getLanguages() const
	{
		return languagesBibliographic;
	}

	const QMap<QString, QString> &LanguageSelectionContainer::getLanguagesTerminology() const
	{
		return languagesTerminology;
	}

	void LanguageSelectionContainer::addLanguageB(const QString &name, const QString &iso)
	{
		languagesBibliographic.insert(make_pair(name, iso));
		languagesReverseBibliographic.insert(make_pair(iso, name));
	}

	void LanguageSelectionContainer::addLanguageT(const QString &name, const QString &iso)
	{
	...
	LanguageSelectionContainer::LanguageSelectionContainer()
	{
		...
		languagesBibliographic = QMap<QString, QString>();
		languagesReverseBibliographic = QMap<QString, QString>();

		languagesTerminology = QMap<QString, QString>();
		languagesReverseTerminology = QMap<QString, QString>();
		...
		addLanguageB("Austronesian (Other)", "QMap");
		...
		addLanguageT("Austronesian (Other)", "QMap");
	...
	QString LanguageSelectionContainer::lookupISOCode(const QString &code)
	{
	...
	QString LanguageSelectionContainer::getISO639dot1(const QString &iso639dot2)
	{
	...
	QString LanguageSelectionContainer::Short2FullLanguageName(const QString &LngCode)
	{
		QString Language = "";
