...
namespace MeXgui
{
	namespace core
	{
		namespace util
		{
			...
			QString WindowUtil::GetText(IntPtr hWnd)
			{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
			...
			QString WindowUtil::GetErrorText(int iErrorValue)
			{
				if (iErrorValue >= 0)
					return StringConverterHelper::toString(iErrorValue);
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				QString strErrorHex = iErrorValue.ToString("X");
...
//ORIGINAL LINE: case "00000107":
				...
				{
						strErrorText = "STATUS_SOME_NOT_QMapPED";
				}
...
//ORIGINAL LINE: case "C0000019":
				...
				{
						strErrorText = "STATUS_NOT_QMapPED_VIEW";
				}
...
//ORIGINAL LINE: case "C0000047":
				...
				{
						strErrorText = "STATUS_SEQMapHORE_LIMIT_EXCEEDED";
				}
...
//ORIGINAL LINE: case "C000004D":
				...
				{
						strErrorText = "STATUS_INCOMPATIBLE_FILE_QMap";
				}
...
//ORIGINAL LINE: case "C0000073":
				...
				{
						strErrorText = "STATUS_NONE_QMapPED";
				}
...
//ORIGINAL LINE: case "C0000088":
				...
				{
						strErrorText = "STATUS_NOT_QMapPED_DATA";
				}
...
//ORIGINAL LINE: case "C00000E6":
				...
				{
						strErrorText = "STATUS_GENERIC_NOT_QMapPED";
				}
...
//ORIGINAL LINE: case "C00000EB":
				...
				{
						strErrorText = "STATUS_UNEXPECTED_MM_QMap_ERROR";
				}
...
//ORIGINAL LINE: case "C000011E":
				...
				{
						strErrorText = "STATUS_QMapPED_FILE_SIZE_ZERO";
				}
...
//ORIGINAL LINE: case "C0000162":
				...
				{
						strErrorText = "STATUS_UNQMapPABLE_CHARACTER";
				}
...
//ORIGINAL LINE: case "C0000220":
				...
				{
						strErrorText = "STATUS_QMapPED_ALIGNMENT";
				}
...
//ORIGINAL LINE: case "C0000243":
				...
				{
						strErrorText = "STATUS_USER_QMapPED_FILE";
				}
...
//ORIGINAL LINE: case "C014000C":
				...
				{
						strErrorText = "STATUS_ACPI_ADDRESS_NOT_QMapPED";
				}
