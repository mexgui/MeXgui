...
namespace MeXgui
{
	...
	public:
		...
		VideoJob *generateVideoJob(const QString &input, const QString &output, VideoCodecSettings *settings, Nullable<Dar> dar, Zone zones[]);
		...
		VideoJob *generateVideoJob(const QString &input, const QString &output, VideoCodecSettings *settings, bool skipVideoCheck, Nullable<Dar> dar, Zone zones[]);

	private:
		void checkVideo(const QString &p);
		/// <summary>
	...
	public:
		...
		JobChain *AddVideoJobs(const QString &movieInput, const QString &movieOutput, VideoCodecSettings *settings, int introEndFrame, int creditsStartFrame, Nullable<Dar> dar, bool prerender, bool checkVideo, Zone zones[]);
		...
		JobChain *prepareVideoJob(const QString &movieInput, const QString &movieOutput, VideoCodecSettings *settings, Nullable<Dar> dar, bool prerender, bool checkVideo, Zone zones[]);
		/// <summary>
	...
	public:
		...
		static bool getInputProperties(quint64 &nbOfFrames, double &framerate, const QString &video);
		/// <summary>
		...
		static bool GetAllInputProperties(quint64 &nbOfFrames, double &framerate, int &framerate_n, int &framerate_d, int &hRes, int &vRes, Dar &dar, const QString &video);
		...
		/// <param name="video">the video whose properties are to be read</param>
		/// <returns>whether the source could be opened or not</returns>
		static bool GetAllInputProperties(quint64 &nbOfFrames, double &framerate, int &hRes, int &vRes, Dar &dar, const QString &video);
		...
		/// <returns></returns>
		quint64 getNumberOfFrames(const QString &path);
		...
		/// <param name="path"></param>
		/// <returns></returns>
		double getFramerate(const QString &path);
		/// <summary>
