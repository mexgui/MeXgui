	...
	namespace core
	{
		namespace details
		{
			namespace video
			{
				...
				void VideoConfigurationPanel::VideoConfigurationPanel_Load(object *sender, EventArgs *e)
				{
					loaded = true;
				...
				std::string VideoConfigurationPanel::getCommandline()
				{
					return "";
				}
				...
				MeGUI::VideoCodecSettings *VideoConfigurationPanel::defaultSettings()
				{
