	...
	namespace core
	{
		namespace details
		{
			...
			public:
				...
				NameTakenException(const std::string &name);
			};
			/// <summary>
			...
			private:
				std::map<std::string, Job*> localJobs;
			...
			private:
				...
				void addToLog(const std::string &p);
