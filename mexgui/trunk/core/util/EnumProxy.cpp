...
namespace MeGUI
{
	...
	const std::string &EnumTitleAttribute::getText() const
	{
		return this->text;
	}
	...
	std::string EnumTitleAttribute::ToString()
	{
		return getText();
	}

	EnumTitleAttribute::EnumTitleAttribute(const std::string &text, object *tag)
	{
		this->text = text;
		this->tag = tag;
	}

	EnumTitleAttribute::EnumTitleAttribute(const std::string &text)
	{
	}

std::map<object*, EnumProxy*> EnumProxy::cache = std::map<object*const , EnumProxy*>();
