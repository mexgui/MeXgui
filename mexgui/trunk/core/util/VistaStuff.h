...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[MarshalAs(UnmanagedType::LPWStr)]
					std::string pszCreator;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[MarshalAs(UnmanagedType::LPWStr)]
					std::string pszDescription;
					Guid *fidParent;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[MarshalAs(UnmanagedType::LPWStr)]
					std::string pszRelativePath;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[MarshalAs(UnmanagedType::LPWStr)]
					std::string pszParsingName;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[MarshalAs(UnmanagedType::LPWStr)]
					std::string pszToolTip;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[MarshalAs(UnmanagedType::LPWStr)]
					std::string pszLocalizedName;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[MarshalAs(UnmanagedType::LPWStr)]
					std::string pszIcon;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[MarshalAs(UnmanagedType::LPWStr)]
					std::string pszSecurity;
...
//[DllImport("user32", CharSet = CharSet::Unicode)]
				__declspec(dllimport) static IntPtr SendMessage(IntPtr hWnd, unsigned int Msg, IntPtr wParam, const std::string &lParam);

//C# TO C++ CONVERTER NOTE: The following .NET DllImport attribute was converted using the Microsoft-specific __declspec(dllimport):
//[DllImport("uxtheme.dll", CharSet = CharSet::Unicode)]
				__declspec(dllimport) static int SetWindowTheme(IntPtr hWnd, const std::string &pszSubAppName, const std::string &pszSubIdList);
