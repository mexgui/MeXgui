...
//[TypeConverter(DarConverter::typeid)]
			...
			public:
				Dar(unsigned long long x, unsigned long long y);

				Dar(decimal dar);

				Dar(Nullable<decimal> dar, unsigned long long width, unsigned long long height);

				Dar(int x, int y, unsigned long long width, unsigned long long height);

				const decimal &getAR() const;
				void setAR(const decimal &value);

				const unsigned long long &getX() const;
				void setX(const unsigned long long &value);

				const unsigned long long &getY() const;
				void setY(const unsigned long long &value);
			...
			public:
				...
				Sar(unsigned long long x, unsigned long long y);
			...
			public:
				static void reduce(unsigned long long &x, unsigned long long &y);

			private:
				static unsigned long long gcd(unsigned long long x, unsigned long long y);

			public:
				static void approximate(decimal val, unsigned long long &x, unsigned long long &y);

				static void approximate(decimal val, unsigned long long &x, unsigned long long &y, double precision);
			};
			/// <summary>
