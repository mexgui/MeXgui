...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int QueryId(std::string&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int NewSegment(long long, long long, double) = 0;
	};
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int AddFilter(IBaseFilter*, const std::string&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int FindFilterByName(const std::string&, IBaseFilter*&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int FindPin(const std::string&, IPin*&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int JoinFilterGraph(IFilterGraph*, const std::string&) = 0;

//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int QueryVendorInfo(std::string&) = 0;
	};
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetDuration(long long&) = 0;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetStopPosition(long long&) = 0;
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetCurrentPosition(long long&) = 0;

//ORIGINAL LINE: int ConvertTimeFormat(out long pTarget, [In] ref Guid pTargetFormat, long Source, [In] ref Guid pSourceFormat);
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int ConvertTimeFormat(long long&, Guid*&, long long, Guid*&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetPositions(long long&, long long&) = 0;

//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetAvailable(long long&, long long&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetPreroll(long long&) = 0;
	};
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetTime(long long&) = 0;

//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int AdviseTime(long long, long long, IntPtr, int&) = 0;

//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int AdvisePeriodic(long long, long long, IntPtr, int&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetTime(long long&, long long&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int GetMediaTime(long long&, long long&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int AllocCapFile(const std::string&, long long) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int RenderFile(const std::string&, const std::string&) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[PreserveSig]
		virtual int AddSourceFilter(const std::string&, const std::string&, IBaseFilter*&) = 0;
...
//[ComVisible(false)]
	...
	public:
		bool checkRender(const std::string &fileName);
	};
}
