...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
	...
	public:
		...
		static std::string GetOSServicePack();
		...
		/// 
		static std::string GetDotNetVersion();
		...
		/// <returns>A string containing the Name of the Framework Version.</returns>
		/// 
		static std::string GetDotNetVersion(const std::string &getSpecificVersion);
		...
		/// 
		static std::string DotNetVersionFormated(const std::string &dotNetVersion);
		...
		/// 
		static std::string GetMOStuff(const std::string &queryObject);

		/// <summary>
		/// Gets the full version of the operating system running on this computer.
		/// </summary>
		const static std::string &getOSVersion() const;
