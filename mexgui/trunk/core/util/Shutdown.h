...
//[DllImport("advapi32.dll", SetLastError = true)]
		__declspec(dllimport) static bool LookupPrivilegeValue(const std::string &host, const std::string &name, long long &pluid);
...
//[DllImport("user32.dll", ExactSpelling = true, SetLastError = true)]
	...
	private:
		...
		static const std::string SE_SHUTDOWN_NAME;
