...
namespace MeGUI
{
	namespace core
	{
		namespace gui
		{
			...
			StandardAndCustomComboBox::StandardAndCustomComboBox(const std::string &clearText, const std::string &chooseNewText) : MeGUI::core::gui::NiceComboBox()
			{
				InitializeInstanceFields();
				InitializeComponent();
...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
				clearItem = new NiceComboBoxNormalItem(clearText, delegate(NiceComboBoxNormalItem i, EventArgs e)
				{
					clearCustomItems();
				}
			   );
...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
				Items.push_back(new NiceComboBoxNormalItem(chooseNewText, 0, delegate(NiceComboBoxNormalItem i, EventArgs e)
				{
					object *o = Getter();
					if (o != 0)
					{
			...
			void StandardAndCustomComboBox::SetFileSCBoxType(const std::string &chooseNewText, const std::string &chooseNewFolder, MeGUI::core::gui::FileSCBox::FileSCBoxType oType)
			{
...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
					Items.push_back(new NiceComboBoxNormalItem(chooseNewFolder, 0, delegate(NiceComboBoxNormalItem i, EventArgs e)
					{
			...
			void StandardAndCustomComboBox::SetTargetSizeSCBoxType(const std::string &clearText, const std::string &chooseCustomSize)
			{
				Items.clear();
				numOpener = 1;
				numStandardItems = numCustomItems = 0;
...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
				Items.push_back(new NiceComboBoxNormalItem(chooseCustomSize, 0, delegate(NiceComboBoxNormalItem i, EventArgs e)
				{
					object *o = Getter();
					if (o != 0)
					{
