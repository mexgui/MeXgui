...
//C# TO C++ CONVERTER TODO TASK: There is no built-in support for multithreading in native C++:
			...
			Bitmap *VideoPlayerControl::resizeBitmap(Bitmap *b, int nWidth, int nHeight)
			{
...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
						Invoke((SimpleDelegate)(delegate
							videoPreview->Image = finalBitmap;
					}
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to the exception 'finally' clause:
					finally
					{
			...
			Bitmap *VideoPlayerControl::getFrame(int pos)
			{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to the exception 'finally' clause:
			...
			void VideoPlayerControl::VideoPlayerControl_Resize(object *sender, EventArgs *e)
			{
				UpdateVideo();
			}

			void VideoPlayerControl::VideoPlayerControl_Load(object *sender, EventArgs *e)
			{
				initalized = true;
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to the exception 'finally' clause:
			...
			void VideoPlayerControl::Dispose(bool disposing)
			{
				...
				if (videoPreview->Image != 0)
					delete videoPreview->Image; // get rid of bitmap
