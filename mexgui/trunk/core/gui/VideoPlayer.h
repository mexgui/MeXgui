...
//		public event ChapterSetCallback ChapterSet;
	...
	private:
		...
		MainForm *mainForm;
		std::string strFileName; // the video file name
		bool bInlineAVS;
...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
	...
	public:
		...
		bool loadVideo(MainForm *mainForm, const std::string &path, PREVIEWTYPE type, bool hasAR);
		...
		/// <returns>true if the video could be opened, false if not</returns>
		bool loadVideo(MainForm *mainForm, const std::string &path, PREVIEWTYPE type, bool hasAR, bool inlineAvs, int startFrame, bool originalSize);
	...
	public:
		...
		/// <param name="e"></param>
	private:
		void btnFitScreen_Click(object *sender, EventArgs *e);
		void setZoomButtons();
	...
	private:
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void positionSlider_Scroll(object *sender, System::EventArgs *e);
		/// <summary>
	...
	private:
		...
		void previousFrameButton_Click(object *sender, System::EventArgs *e);

		void nextFrameButton_Click(object *sender, System::EventArgs *e);

		void fwdButton_Click(object *sender, System::EventArgs *e);

		void ffButton_Click(object *sender, System::EventArgs *e);
		/// <summary>
		/// fires an event indicating the credits start position has been set.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void creditsStartButton_Click(object *sender, System::EventArgs *e);
		/// <summary>
		/// fires an event indicating that the intro end position has been set
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void introEndButton_Click(object *sender, System::EventArgs *e);
		void zoneEndButton_Click(object *sender, System::EventArgs *e);

		void zoneStartButton_Click(object *sender, System::EventArgs *e);

		void setZoneButton_Click(object *sender, System::EventArgs *e);
		void chapterButton_Click(object *sender, System::EventArgs *e);
		void mnuIntroEnd_Click(object *sender, System::EventArgs *e);

		void mnuCreditsStart_Click(object *sender, System::EventArgs *e);

		void mnuZoneStart_Click(object *sender, System::EventArgs *e);

		void mnuZoneEnd_Click(object *sender, System::EventArgs *e);
	...
	private:
		...
		void showPAR_CheckedChanged(object *sender, EventArgs *e);

		void goToFrameButton_Click(object *sender, EventArgs *e);

		void arChooser_SelectionChanged(object *sender, const std::string &val);

		void nextFrameButton_KeyDown(object *sender, KeyEventArgs *e);

		void previousFrameButton_KeyDown(object *sender, KeyEventArgs *e);

		void videoPreview_PositionChanged(object *sender, EventArgs *e);

		void btnReloadVideo_Click(object *sender, EventArgs *e);

		void VideoPlayer_Shown(object *sender, EventArgs *e);
