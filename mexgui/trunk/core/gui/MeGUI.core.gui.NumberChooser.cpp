...
namespace MeGUI
{
	namespace core
	{
		namespace gui
		{
			...
			DialogResult *NumberChooser::ShowDialog(const std::string &message, const std::string &title, int decimals, decimal min, decimal max, decimal defaultNum, decimal &number)
			{
			...
			void NumberChooser::NumberChooser_Shown(object *sender, EventArgs *e)
			{
