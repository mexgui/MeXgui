...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
		...
		/*        public ProfileConfigurationWindow(ProfileManager p, Control sPanel, Gettable<TSettings> s, string initialProfile)
				...
				ProfileConfigurationWindow(TPanel t, const std::string &title)
				{
			...
			private:
				void loadDefaultsButton_Click(object *sender, EventArgs *e)
				{
				...
				void newVideoProfileButton_Click(object *sender, EventArgs *e)
				{
					std::string profileName = InputBox::Show("Please give the preset a name", "Please give the preset a name", "");
					if (profileName == "")
						return;
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'Trim' method:
			...
			private:
				GenericProfile<TSettings> *byName(const std::string &profileName)
				{
				...
				void videoProfile_SelectedIndexChanged(object *sender, EventArgs *e)
				{
					this->setSettings(getSelectedProfile()->getSettings());
				}

				void deleteVideoProfileButton_Click(object *sender, EventArgs *e)
				{
				...
				void ProfileConfigurationWindow_FormClosing(object *sender, FormClosingEventArgs *e)
				{
