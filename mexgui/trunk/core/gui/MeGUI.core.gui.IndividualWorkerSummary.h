...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
			...
			private:
				void startEncodingToolStripMenuItem_Click(object *sender, EventArgs *e);

				void abortToolStripMenuItem_Click(object *sender, EventArgs *e);
				...
				void shutDownLaterToolStripMenuItem_Click(object *sender, EventArgs *e);

				void showProgressWindowToolStripMenuItem_Click(object *sender, EventArgs *e);

				void showQueueToolStripMenuItem_Click(object *sender, EventArgs *e);
