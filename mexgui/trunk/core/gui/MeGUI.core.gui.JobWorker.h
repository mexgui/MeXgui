	...
	namespace core
	{
		namespace gui
		{
			...
			private:
				...
				public:
					ExceptionType type;
					JobStartException(const std::string &reason, ExceptionType type);
				};
			private:
...
//				public event EventHandler WorkerFinishedJobs;
			...
			private:
				std::map<std::string, TaggedJob*> localJobs;
			...
			private:
				...
				void shutDownWhenFinishedLocalQueueToolStripMenuItem_Click(object *sender, EventArgs *e);

				void shutDownWorkerNowToolStripMenuItem_Click(object *sender, EventArgs *e);

				void showProgressWindowToolStripMenuItem_Click(object *sender, EventArgs *e);

			public:
				void RefreshInfo();

			private:
				void jobQueue1_AbortClicked(object *sender, EventArgs *e);

				void jobQueue1_StartClicked(object *sender, EventArgs *e);

				void jobQueue1_StopClicked(object *sender, EventArgs *e);
			...
			private:
				void progressWindowToolStripMenuItem_DropDownOpened(object *sender, EventArgs *e);
			...
			private:
				void JobWorker_FormClosed(object *sender, FormClosedEventArgs *e);
