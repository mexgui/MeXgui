...
//[PreserveSig]
		...
		virtual void SetProgressValue(IntPtr, unsigned long long, unsigned long long) = 0;
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
		virtual void SetOverlayIcon(IntPtr, IntPtr, const std::string&) = 0;
//ORIGINAL LINE: void SetThumbnailTooltip(IntPtr hwnd, [MarshalAs(UnmanagedType.LPWStr)] string pszTip);
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
		virtual void SetThumbnailTooltip(IntPtr, const std::string&) = 0;
