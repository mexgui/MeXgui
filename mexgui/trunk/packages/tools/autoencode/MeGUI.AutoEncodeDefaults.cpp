#include "MeGUI.AutoEncodeDefaults.h"
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
	...
	void AutoEncodeDefaults::FileSizeRadio_CheckedChanged(object *sender, EventArgs *e)
	{
	...
	void AutoEncodeDefaults::container_SelectedIndexChanged(object *sender, EventArgs *e)
	{
