...
#include "core/gui/MeGUI.AdaptiveMuxWindow.h"
...
namespace MeGUI
{
	...
	{
	private:
		std::vector<AudioJob*> audioStreams;
		bool prerender;
		MainForm *mainForm;
		JobUtil *jobUtil;
		VideoUtil *vUtil;
...
//ORIGINAL LINE: public AutoEncodeWindow(VideoStream videoStream, List<AudioJob> audioStreams, MainForm mainForm, bool prerender, VideoInfo vInfo) : this()
		AutoEncodeWindow(VideoStream *videoStream, std::vector<AudioJob*> &audioStreams, MainForm *mainForm, bool prerender, VideoInfo *vInfo);
		/// <summary>
	...
	private:
		...
		/// <param name="e"></param>
		void container_SelectedIndexChanged(object *sender, EventArgs *e);
		/// <summary>
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void outputFormat_CheckedChanged(object *sender, System::EventArgs *e);
		/// <summary>
		...
		void containerOverhead_ValueChanged(object *sender, System::EventArgs *e);
		void projectedBitrate_TextChanged(object *sender, System::EventArgs *e);
