...
namespace MeGUI
{
	...
	const std::string &AVCLevelTool::getName() const
	{
	...
	const std::string &AVCLevelTool::getID() const
	{
...
const Levels AVCLevels::SupportedLevels[18] = {L_10, L_1B, L_11, L_12, L_13, L_20, L_21, L_22, L_30, L_31, L_32, L_40, L_41, L_42, L_50, L_51, L_52, L_UNRESTRICTED};
	...
	std::string AVCLevels::GetLevelText(Levels avcLevel)
	{
		switch (avcLevel)
		{
			case L_10:
	...
	const std::string &AVCLevelEnforcementReturn::getPanicString() const
	{
		return panicString;
	}

	void AVCLevelEnforcementReturn::setPanicString(const std::string &value)
	{
		panicString = value;
	}
}
