...
namespace MeGUI
{
	class AVCLevelTool : public MeGUI::core::plugins::interfaces::ITool
	{
...
//[EnumTitle("Unrestricted/Autoguess")]
	...
	public:
		...
		static std::string GetLevelText(Levels avcLevel);
	...
	private:
		...
		std::string panicString; // Description of the error that caused the panic
	...
	public:
		...
		const std::string &getPanicString() const;
		void setPanicString(const std::string &value);
	};
}
