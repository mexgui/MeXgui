...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
	...
	private:
		...
		void QuantizerMatrixDialog_Load(object *sender, System::EventArgs *e);
	...
	private:
		...
		void predefinedMatrix_SelectedIndexChanged(object *sender, System::EventArgs *e);
		void matrixSize_SelectedIndexChanged(object *sender, System::EventArgs *e);
		void matrixType_SelectedIndexChanged(object *sender, System::EventArgs *e);
		/// <summary>
		...
		std::string convertMatrixToString(int matrix[][]);
		/// <summary>
		...
		/// <returns></returns>
		int **convertStringToMatrix(const std::string &matrix, int size);
		...
		/// <param name="e"></param>
		void saveMatrixButton_Click(object *sender, System::EventArgs *e);
		/// <summary>
		/// loads a matrix from file
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void loadMatrixButton_Click(object *sender, System::EventArgs *e);
	...
	class CQMEditorTool : public MeGUI::core::plugins::interfaces::ITool
	{
