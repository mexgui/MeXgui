		...
		namespace tools
		{
			namespace calculator
			{
				...
				private:
					...
					static const std::string qualityCodecModifierValues;

				public:
//C# TO C++ CONVERTER TODO TASK: Calls to same-class constructors are not supported in C++ prior to C++0x:
//ORIGINAL LINE: public CalcData(long frames, decimal fps) : this(frames, fps, nullptr, nullptr, false, nullptr)
					CalcData(long long frames, decimal fps);

					CalcData(long long frames, decimal fps, MeGUI::ContainerType *container, MeGUI::VideoCodec *codec, bool bframes, AudioBitrateCalculationStream audios[]);

							private:
								MeGUI::ContainerType *privateContainerType;
							public:
								const MeGUI::ContainerType &getContainerType() const;
								void setContainerType(const MeGUI::ContainerType &value);
							private:
								MeGUI::VideoCodec *privateVideoCodec;
							public:
								const MeGUI::VideoCodec &getVideoCodec() const;
								void setVideoCodec(const MeGUI::VideoCodec &value);
							private:
...
//C# TO C++ CONVERTER WARNING: Since the array size is not known in this declaration, C# to C++ Converter has converted this array to a pointer.  You will need to call 'delete[]' where appropriate:
							...
							private:
								long long privateFrames;
							public:
								const long long &getFrames() const;
								void setFrames(const long long &value);
							private:
				...
				private:
					...
					long long GetM2tsVideoOverhead(int iAudioStreamCount);
					...
					/// <returns>overhead this audio track will incurr</returns>
					static int GetM2tsAudioOverhead(AudioType *audioType, long long lFrames, unsigned long long length, unsigned long long lFileSize, bool bVideohandling);
