...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
				...
				private:
					...
					void selectExtraFile(const std::string &file);

								MeGUI::core::util::FileSize privateFileSize;
							public:
								const MeGUI::core::util::FileSize &getFileSize() const;
								void setFileSize(const MeGUI::core::util::FileSize &value);
				...
				private:
					...
					void selectButton_Enter(object *sender, EventArgs *e);
