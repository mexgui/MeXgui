#include "MeGUI.packages.tools.oneclick.OneClickConfigPanel.h"
		...
		namespace tools
		{
			namespace oneclick
			{
				...
				OneClickConfigPanel::OneClickConfigPanel()
				{
					...
					for (std::vector<ContainerType*>::const_iterator t = mainForm->getMuxProvider()->GetSupportedContainers().begin(); t != mainForm->getMuxProvider()->GetSupportedContainers().end(); ++t)
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
					...
					audioConfigurations = std::vector<OneClickAudioControl*>();
					audioConfigurations.push_back(oneClickAudioControl1);
					oneClickAudioControl1->SetDefault();
					cbUnknownLanguage->Items->AddRange((std::vector<std::string>(LanguageSelectionContainer::getLanguages().Keys))->ToArray());
					cbUnknownLanguage->SelectedItem = "English";

				}

				const MeGUI::OneClickSettings &OneClickConfigPanel::getSettings() const
				{
					...
					val->setOutputResolution(static_cast<long long>(horizontalResolution->Value));
					...
					std::vector<OneClickAudioSettings*> arrSettings = std::vector<OneClickAudioSettings*>();
					...
					std::vector<std::string> arrDefaultAudio = std::vector<std::string>();
					...
					std::vector<std::string> arrDefaultSubtitle = std::vector<std::string>();
					...
					std::vector<std::string> arrIndexerPriority = std::vector<std::string>();
				...
				void OneClickConfigPanel::setSettings(const OneClickSettings &value)
				{
					...
					int i = 0;
					AudioResetTrack();
					for (std::vector<OneClickAudioSettings*>::const_iterator o = value->getAudioSettings().begin(); o != value->getAudioSettings().end(); ++o)
					{
						if (i++ == 0)
						{
					...
					std::vector<std::string> arrNonDefaultAudio = std::vector<std::string>(LanguageSelectionContainer::getLanguages().Keys);
					arrNonDefaultAudio.push_back("[none]");
					for (std::vector<std::string>::const_iterator strLanguage = value->getDefaultAudioLanguage().begin(); strLanguage != value->getDefaultAudioLanguage().end(); ++strLanguage)
						arrNonDefaultAudio.Remove(*strLanguage);

					std::vector<std::string> arrNonDefaultSubtitle = std::vector<std::string>(LanguageSelectionContainer::getLanguages().Keys);
					arrNonDefaultSubtitle.push_back("[none]");
					for (std::vector<std::string>::const_iterator strLanguage = value->getDefaultSubtitleLanguage().begin(); strLanguage != value->getDefaultSubtitleLanguage().end(); ++strLanguage)
				...
				const std::string &OneClickConfigPanel::getContainerCandidates() const
				{
					std::string val[containerTypeList->CheckedItems->Count];
					containerTypeList->CheckedItems->CopyTo(val, 0);
					return val;
				}

				void OneClickConfigPanel::setContainerCandidates(const std::string &value[])
				{
					for (int i = 0; i < containerTypeList->Items->Count; i++)
						containerTypeList->SetItemChecked(i, false);

					for (std::string[]::const_iterator val = value->begin(); val != value->end(); ++val)
					{
				...
				void OneClickConfigPanel::keepInputResolution_CheckedChanged(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::videoProfile_SelectedProfileChanged(object *sender, EventArgs *e)
				{
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'StartsWith' method:
				...
				void OneClickConfigPanel::chkDontEncodeVideo_CheckedChanged(object *sender, EventArgs *e)
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'StartsWith' method:
				...
				void OneClickConfigPanel::btnAddAudio_Click(object *sender, EventArgs *e)
				{
					std::vector<std::string> arrAudio = std::vector<std::string>();
					...
					for (std::vector<std::string>::const_iterator s = arrAudio.begin(); s != arrAudio.end(); ++s)
						lbNonDefaultAudio->Items->Remove(*s);
				}

				void OneClickConfigPanel::btnRemoveAudio_Click(object *sender, EventArgs *e)
				{
					std::vector<std::string> arrAudio = std::vector<std::string>();
				...
				void OneClickConfigPanel::btnAudioUp_Click(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::btnAudioDown_Click(object *sender, EventArgs *e)
				{
					int iPos = lbDefaultAudio->SelectedIndex;
				...
				void OneClickConfigPanel::lbDefaultAudio_SelectedIndexChanged(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::lbNonDefaultAudio_SelectedIndexChanged(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::btnAddSubtitle_Click(object *sender, EventArgs *e)
				{
					std::vector<std::string> arrSubtitle = std::vector<std::string>();
					...
					for (std::vector<std::string>::const_iterator s = arrSubtitle.begin(); s != arrSubtitle.end(); ++s)
						lbNonDefaultSubtitle->Items->Remove(*s);
				}

				void OneClickConfigPanel::btnRemoveSubtitle_Click(object *sender, EventArgs *e)
				{
					std::vector<std::string> arrSubtitle = std::vector<std::string>();
				...
				void OneClickConfigPanel::btnSubtitleUp_Click(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::btnSubtitleDown_Click(object *sender, EventArgs *e)
				{
					int iPos = lbDefaultSubtitle->SelectedIndex;
				...
				void OneClickConfigPanel::lbDefaultSubtitle_SelectedIndexChanged(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::lbNonDefaultSubtitle_SelectedIndexChanged(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::btnIndexerUp_Click(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::btnIndexerDown_Click(object *sender, EventArgs *e)
				{
					int iPos = lbIndexerPriority->SelectedIndex;
				...
				void OneClickConfigPanel::audioAddTrack_Click(object *sender, EventArgs *e)
				{
					AudioAddTrack(0);
				}

				void OneClickConfigPanel::audioRemoveTrack_Click(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::audio1_LanguageChanged(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::audioTab_SelectedIndexChanged(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::audioTab_VisibleChanged(object *sender, EventArgs *e)
				{
					if (!audioTab->Visible || audioTab->TabCount == audioConfigurations.size() + 1)
						return;

					std::vector<OneClickAudioSettings*> arrSettings = std::vector<OneClickAudioSettings*>();
					for (std::vector<OneClickAudioControl*>::const_iterator o = audioConfigurations.begin(); o != audioConfigurations.end(); ++o)
					...
					AudioResetTrack();
					int i = 0;
					for (std::vector<OneClickAudioSettings*>::const_iterator o = arrSettings.begin(); o != arrSettings.end(); ++o)
					{
						if (i++ == 0)
						{
				...
				void OneClickConfigPanel::deleteOutput_Click(object *sender, EventArgs *e)
				{
					outputDirectory->setFilename("");
				}

				void OneClickConfigPanel::deleteWorking_Click(object *sender, EventArgs *e)
				{
				...
				void OneClickConfigPanel::InitializeComponent()
				{
					...
					// splitSize
					// 
					this->splitSize->setCustomSizes(new MeGUI::core::util::FileSize[0]);
