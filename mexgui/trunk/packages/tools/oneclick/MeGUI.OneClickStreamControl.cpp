...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
	...
	void OneClickStreamControl::SelectProfileNameOrWarn(const std::string &fqname)
	{
	...
	const std::string &OneClickStreamControl::getEncoderProfile() const
	{
	...
	void OneClickStreamControl::setStream(const OneClickStream &value)
	{
		...
		MeGUI::core::gui::NiceComboBoxItem *oItem = new core::gui::NiceComboBoxItem(value->getDemuxFilePath(), value);
	...
	void OneClickStreamControl::setDefaultLanguage(const std::string &value)
	{
		defaultLanguage = value;
	}

	const std::string &OneClickStreamControl::getDefaultLanguage() const
	{
	...
	const std::string &OneClickStreamControl::getFilter() const
	{
		return input->getFilter();
	}

	void OneClickStreamControl::setFilter(const std::string &value)
	{
	...
	const MeGUI::core::gui::SCItem &OneClickStreamControl::getSelectedItem() const
	{
	...
	const std::string &OneClickStreamControl::getSelectedFile() const
	{
		return input->getSelectedText();
	}

	void OneClickStreamControl::SetLanguage(const std::string &lang)
	{
		subtitleLanguage->SelectedItem = lang;
	}

	void OneClickStreamControl::removeTrack_Click(object *sender, EventArgs *e)
	{
		input->Text = "";
	...
	void OneClickStreamControl::chkForceStream_CheckedChanged(object *sender, EventArgs *e)
	{
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'TrimEnd' method:
	...
	void OneClickStreamControl::chkDefaultStream_CheckedChanged(object *sender, EventArgs *e)
	{
		if (dynamic_cast<OneClickStream*>(input->getSelectedObject()) != 0)
			(static_cast<OneClickStream*>(input->getSelectedObject()))->setDefaultStream(chkDefaultStream->Checked);
	}

	void OneClickStreamControl::setFileName(const std::string &strFileName)
	{
		input->AddCustomItem(strFileName);
		input->setSelectedObject(strFileName);
	}

	void OneClickStreamControl::input_SelectionChanged(object *sender, const std::string &val)
	{
		// get language
		bool bFound = false;
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'EndsWith' method:
	...
	void OneClickStreamControl::encoderProfile_SelectedProfileChanged(object *sender, EventArgs *e)
	{
		raiseEvent();
	}

	void OneClickStreamControl::cbEncodingMode_SelectedIndexChanged(object *sender, EventArgs *e)
	{
...
//C# TO C++ CONVERTER WARNING: C# to C++ Converter converted the original 'null' assignment to a call to 'delete', but you should review memory allocation of all pointer variables in the converted code:
		...
		this->input->setType(MeGUI::core::gui::FileSCBox::OC_FILE);
		this->input->SelectionChanged += new MeGUI::StringChanged(this, &OneClickStreamControl::input_SelectionChanged);
		// 
		// label1
		// 
