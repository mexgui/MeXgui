...
std::string x264Settings::ID = "x264";
const x264PsyTuningModes x264Settings::SupportedPsyTuningModes[7] = {NONE, ANIMATION, FILM, GRAIN, STILLIMAGE, PSNR, SSIM};
	...
	void x264Settings::FixFileNames(std::map<std::string, std::string> &substitutionTable)
	{
	...
	const std::string &x264Settings::getRequiredFiles() const
	{
		std::vector<std::string> list = std::vector<std::string>(VideoCodecSettings::getRequiredFiles());
	...
	const MeGUI::x264Settings::x264PresetLevelModes &x264Settings::getx264PresetLevel() const
	{
		return preset;
	}
	...
	const std::string &x264Settings::getx264Tuning() const
	{
		return "migrated";
	}

	void x264Settings::setx264Tuning(const std::string &value)
	{
	...
	const MeGUI::x264Settings::x264PsyTuningModes &x264Settings::getx264PsyTuning() const
	{
	...
	const MeGUI::x264Settings::x264InterlacedModes &x264Settings::getInterlacedMode() const
	{
	...
	const std::string &x264Settings::getTargetDeviceXML() const
	{
		return StringConverterHelper::toString(targetDevice->getID());
	}

	void x264Settings::setTargetDeviceXML(const std::string &value)
	{
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'Split' method:
	...
	const std::string &x264Settings::getBlurayCompatXML() const
	{
		return StringConverterHelper::toString(blurayCompat);
	}

	void x264Settings::setBlurayCompatXML(const std::string &value)
	{
	...
	const std::string &x264Settings::getQuantizerMatrix() const
	{
		return quantizerMatrix;
	}

	void x264Settings::setQuantizerMatrix(const std::string &value)
	{
	...
	const std::string &x264Settings::getOpenGop() const
	{
		return openGop;
	}

	void x264Settings::setOpenGop(const std::string &value)
	{
	...
	const std::string &x264Settings::getQPFile() const
	{
		return qpfile;
	}

	void x264Settings::setQPFile(const std::string &value)
	{
		qpfile = value;
	}

	const std::string &x264Settings::getRange() const
	{
	...
	void x264Settings::setRange(const std::string &value)
	{
		range = value;
	}
	...
	const std::string &x264Settings::getLevel() const
	{
		return "migrated";
	}

	void x264Settings::setLevel(const std::string &value)
	{
		if (value.Equals("migrated"))
			return;
