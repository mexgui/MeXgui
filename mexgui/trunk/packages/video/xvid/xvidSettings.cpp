...
const std::string xvidSettings::ID = "XviD";
const std::string xvidSettings::H263Matrix = "H.263";
const std::string xvidSettings::MPEGMatrix = "MPEG";
	...
	void xvidSettings::FixFileNames(std::map<std::string, std::string> &substitutionTable)
	{
	...
	const std::string &xvidSettings::getRequiredFiles() const
	{
...
const std::string xvidSettings::m_fourCCs[4] = {"XVID", "DIVX", "DX50", "MP4V"};

	const std::string &xvidSettings::getFourCCsForMPEG4ASP() const
	{
		return m_fourCCs;
	}
	...
	const std::string &xvidSettings::getQuantizerMatrix() const
	{
		return customQuantizerMatrix;
	}

	void xvidSettings::setQuantizerMatrix(const std::string &value)
	{
