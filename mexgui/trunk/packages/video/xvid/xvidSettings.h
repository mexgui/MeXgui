...
namespace MeGUI
{
	...
	public:
		...
		static const std::string H263Matrix;
		static const std::string MPEGMatrix;
	...
	private:
		...
		std::string customQuantizerMatrix;
	public:
	...
	private:
		static const std::string m_fourCCs[4];

	public:
		const static std::string *getFourCCsForMPEG4ASP() const;
