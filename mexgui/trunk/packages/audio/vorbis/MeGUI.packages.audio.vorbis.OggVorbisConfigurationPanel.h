...
namespace MeGUI
{
	namespace packages
	{
		namespace audio
		{
			namespace vorbis
			{
				class OggVorbisConfigurationPanel : public MeGUI::core::details::audio::AudioConfigurationPanel, Editable<OggVorbisSettings*>
				{
					public:
...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
				...
				private:
					void vQuality_ValueChanged(object *sender, EventArgs *e);
