#include "MeGUI.packages.audio.lame.lameConfigurationPanel.h"
	...
	namespace packages
	{
		namespace audio
		{
			namespace lame
			{
				...
				lameConfigurationPanel::lameConfigurationPanel() : MeGUI::core::details::audio::AudioConfigurationPanel()
				{
				...
				const MeGUI::AudioCodecSettings &lameConfigurationPanel::getCodecSettings() const
				{
				...
				const MeGUI::MP3Settings &lameConfigurationPanel::getSettings() const
				{
				...
				void lameConfigurationPanel::cbrMode_CheckedChanged(object *sender, EventArgs *e)
				{
					cbrBitrate->Enabled = true;
					vbrValue->Enabled = abrValue->Enabled = false;
				}

				void lameConfigurationPanel::abrMode_CheckedChanged(object *sender, EventArgs *e)
				{
					abrValue->Enabled = true;
					vbrValue->Enabled = cbrBitrate->Enabled = false;
				}

				void lameConfigurationPanel::vbrMode_CheckedChanged(object *sender, EventArgs *e)
				{
