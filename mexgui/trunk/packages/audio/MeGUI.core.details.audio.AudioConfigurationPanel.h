...
//[Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility::Hidden)]
				...
				private:
					...
					void besweetDelay_TextChanged(object *sender, System::EventArgs *e);

					void applyDRC_CheckedChanged(object *sender, EventArgs *e);

					void autoGain_CheckedChanged(object *sender, EventArgs *e);
