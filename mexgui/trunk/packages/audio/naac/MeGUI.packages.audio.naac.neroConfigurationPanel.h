...
namespace MeGUI
{
	namespace packages
	{
		namespace audio
		{
			namespace naac
			{
				class neroConfigurationPanel : public MeGUI::core::details::audio::AudioConfigurationPanel, Editable<NeroAACSettings*>
				{
				public:
					TrackBar *vQuality;
					RadioButton *rbtnVBR;
...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
				...
				private:
					void rbtnABR_CheckedChanged(object *sender, EventArgs *e);

					void vBitrate_ValueChanged(object *sender, EventArgs *e);
