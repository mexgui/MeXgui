...
//C# TO C++ CONVERTER WARNING: Since the array size is not known in this declaration, C# to C++ Converter has converted this array to a pointer.  You will need to call 'delete[]' where appropriate:
				...
				public:
					const QString *getInputFiles() const;
					void setInputFiles(QString value[]);

					QString generateJoinCommandline(const QString &tempFilename);

					AudioJoinJob();

					AudioJoinJob(QString& inputFiles[], const QString &output);
