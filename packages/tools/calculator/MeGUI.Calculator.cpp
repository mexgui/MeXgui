...
//C# TO C++ CONVERTER TODO TASK: Lambda expressions and anonymous methods are not converted to native C++ unless the option to convert to C++0x lambdas is selected:
	...
	void Calculator::SetDefaults(quint64 nbFrames, double framerate, int hRes, int vRes, VideoCodecSettings *vSettings, QVector<AudioJob*> &audioStreams)
	{
		...
		for (QVector<AudioJob*>::const_iterator job = audioStreams.begin(); job != audioStreams.end(); ++job)
		{
			MeXgui::packages::tools::calculator::AudioTrackSizeTab *a = AddAudio();
			a->SetAudioJob(*job);
		}
	...
	void Calculator::audio_SelectedIndexChanged()
	{
		UpdateContainers();
		Calculate();
	}

	void Calculator::textField_TextChanged()
	{
//C# TO C++ CONVERTER TODO TASK: There is no built-in support for multithreading in native C++:
	...
	void Calculator::time_ValueChanged()
	{
//C# TO C++ CONVERTER TODO TASK: There is no built-in support for multithreading in native C++:
		lock (this)
		{
	...
	void Calculator::calculationMode_CheckedChanged()
	{
	...
	void Calculator::codec_CheckedChanged()
	{
		UpdateContainers();
		Calculate();
	}

	void Calculator::bframes_CheckedChanged()
	{
		Calculate();
	}

	void Calculator::targetSize_SelectionChanged(object *sender, const QString &val)
	{
		Calculate();
	}

	void Calculator::fpsChooser_SelectionChanged(object *sender, const QString &val)
	{
	...
	void Calculator::addExtraToolStripMenuItem_Click()
	{
		AddExtra();
	}

	void Calculator::addAudioToolStripMenuItem_Click()
	{
		AddAudio();
	}

	void Calculator::addAudioLink_Clicked()
	{
		contextMenuStrip1->Show(addAudioLink, 0, addAudioLink->Height);
	}

	void Calculator::picTime_Click()
	{
	...
	void Calculator::UpdateTotalSeconds()
	{
		...
		timeText->Text = QString::Format("{0}h {1}m {2}s", this->hours->Value, this->minutes->Value, this->seconds->Value);
	}
	...
	void Calculator::UpdateContainers()
	{
		...
		QVector<MuxableType*> muxableTypes = QVector<MuxableType*>();
	...
	MeXgui::packages::tools::calculator::AudioTrackSizeTab *Calculator::AddAudio()
	{
	...
	MeXgui::packages::tools::calculator::ExtraSizeTab *Calculator::AddExtra()
	{
...
//C# TO C++ CONVERTER TODO TASK: C++ does not have an equivalent to the C# 'yield' keyword:
	...
	MeXgui::core::util::FileSize Calculator::GetTotalExtraSize()
	{
...
//C# TO C++ CONVERTER TODO TASK: C++ does not have an equivalent to the C# 'yield' keyword:
	...
	void Calculator::Calculate()
	{
		...
		try
		{
			...
			CalcData *data = new CalcData(static_cast<qint64>(nbFrames->Value), tempVar::HasValue ? tempVar : 0);
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
	...
	void Calculator::InitializeComponent()
	{
		...
		this->fpsChooser = new MeXgui::core::gui::FPSChooser();
		...
		this->applyButton = new QPushButton;
		...
		this->fpsChooser->SelectionChanged += new MeXgui::StringChanged(this, &Calculator::fpsChooser_SelectionChanged);
		// 
		// nbFrames
		// 
		...
		this->targetSize->SelectionChanged += new MeXgui::StringChanged(this, &Calculator::targetSize_SelectionChanged);
		// 
		// projectedBitrate
		// 
		...
		this->Text = "MeXgui - Bitrate Calculator";
