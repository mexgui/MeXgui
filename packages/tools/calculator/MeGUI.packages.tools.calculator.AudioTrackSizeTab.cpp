	...
	namespace packages
	{
		namespace tools
		{
			namespace calculator
			{
				...
				const qint64 &AudioTrackSizeTab::getPlayLength() const
				{
					return length;
				}

				void AudioTrackSizeTab::setPlayLength(const qint64 &value)
				{
					length = value;
					audio1Bitrate_ValueChanged(0, 0);
				}

				void AudioTrackSizeTab::audio1Bitrate_ValueChanged()
				{
					if (length <= 0)
						return;
					...
					FileSize f = FileSize(static_cast<quint64>(length * bytesPerSecond));
					//size.CertainValue = f;
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				...
				void AudioTrackSizeTab::selectAudioFile(const QString &file)
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
					size->Text = f.ToString();
					audio1Bitrate->Value = (length > 0) ? static_cast<qint64>(f.getBytes() * 8) / 1000LL / length : 0;
				...
				void AudioTrackSizeTab::selectButton_Click()
				{
				...
				const MeXgui::core::details::AudioBitrateCalculationStream &AudioTrackSizeTab::getStream() const
				{
				...
				void AudioTrackSizeTab::size_SelectionChanged(object *sender, const QString &val)
				{
					if (length <= 0)
						return;
				...
				void AudioTrackSizeTab::audio1Type_SelectedIndexChanged()
				{
				...
				void AudioTrackSizeTab::removeLink_LinkClicked()
				{
					if (this->Parent != 0)
						this->Parent->Controls->Remove(this);
				}

				void AudioTrackSizeTab::AudioTrackSizeTab_Enter()
				{
					selectButton->Focus();
				}
