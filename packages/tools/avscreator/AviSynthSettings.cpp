...
QString AviSynthSettings::ID = "AviSynth";

	const QString &AviSynthSettings::getSettingsID() const
	{
		return ID;
	}

	void AviSynthSettings::FixFileNames(QMap<QString, QString> &_)
	{
	}
	...
	AviSynthSettings::AviSynthSettings(const QString &template_Renamed, ResizeFilterType resizeMethod, bool resize, bool upsize, DenoiseFilterType denoiseMethod, bool denoise, bool mpeg2deblock, bool colourCorrect, mod16Method method, bool dss2, modValue modValueUsed, decimal acceptableAspectError)
	{
	...
	MeXgui::core::plugins::interfaces::GenericSettings *AviSynthSettings::GenericSettings_Clone()
	{
	...
	const QString &AviSynthSettings::getTemplate() const
	{
		return template_Renamed;
	}

	void AviSynthSettings::setTemplate(const QString &value)
	{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
	...
	const QString &AviSynthSettings::getRequiredFiles() const
	{
		return new QString[0];
	}

	const QString &AviSynthSettings::getRequiredProfiles() const
	{
		return new QString[0];
	}
}
