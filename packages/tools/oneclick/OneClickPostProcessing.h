...
//C# TO C++ CONVERTER WARNING: Since the array size is not known in this declaration, C# to C++ Converter has converted this array to a pointer.  You will need to call 'delete[]' where appropriate:
	...
	private:
		...
		void fillInAudioInformation(QVector<AudioJob*> &arrAudioJobs, QVector<MuxStream*> &arrMuxStreams);
		...
		/// <returns></returns>
		QString convertTrackNumberToFile(const QString &input, int &delay);
		...
		QString createAVSFile(const QString &indexFile, const QString &inputFile, Nullable<Dar> AR, int desiredOutputWidth, bool signalAR, LogItem *_log, AviSynthSettings *avsSettings, bool autoDeint, VideoCodecSettings *settings, Nullable<Dar> &dar, bool autoCrop, bool keepInputResolution, bool useChaptersMarks);
