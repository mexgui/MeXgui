	...
	namespace packages
	{
		namespace tools
		{
			namespace oneclick
			{
				...
				void AudioConfigControl::audioCodec_SelectedIndexChanged()
				{
					raiseEvent();
				}
				...
				void AudioConfigControl::dontEncodeAudio_CheckedChanged()
				{
				...
				const MeXgui::AudioCodecSettings &AudioConfigControl::getSettings() const
				{
				...
				void AudioConfigControl::openAudioFile(const QString &p)
				{
				...
				const MeXgui::AudioEncodingMode &AudioConfigControl::getAudioEncodingMode() const
				{
					return static_cast<MeXgui::AudioEncodingMode>(cbAudioEncoding->SelectedIndex);
				}

				void AudioConfigControl::setAudioEncodingMode(const MeXgui::AudioEncodingMode &value)
				{
				...
				void AudioConfigControl::SelectProfileNameOrWarn(const QString &fqname)
				{
