	...
	namespace packages
	{
		namespace tools
		{
			namespace cutter
			{
				...
				Cutter::Cutter(MainForm *mainForm, const QString &scriptName)
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				...
				void Cutter::addZoneButton_Click()
				{
				...
				void Cutter::updateListView()
				{
					...
					for (QVector<CutSection*>::const_iterator cut = cuts->getAllCuts().begin(); cut != cuts->getAllCuts().end(); ++cut)
					{
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
						ListViewItem *item = new ListViewItem(new QString[] {(*cut)->startFrame->ToString(), (*cut)->endFrame->ToString()});
						item->Tag = *cut;
				...
				void Cutter::clearZonesButton_Click()
				{
				...
				void Cutter::updateZoneButton_Click()
				{
					Cuts *old = cuts->clone();
					removeSelectedZones();
				...
				void Cutter::removeZoneButton_Click()
				{
...
//C# TO C++ CONVERTER WARNING: C# to C++ Converter converted the original 'null' assignment to a call to 'delete', but you should review memory allocation of all pointer variables in the converted code:
				...
				void Cutter::closeButton_Click()
				{
					Close();
				}

				void Cutter::transitionStyle_SelectedIndexChanged()
				{
					cuts->Style = static_cast<TransitionStyle>(transitionStyle->SelectedIndex);
				}

				void Cutter::addCutsToScript_Click()
				{
					if (cutsAdded)
					{
				...
				void Cutter::saveCuts_Click()
				{
					...
					d->Filter = "MeXgui cut list (*.clt)|*.clt";
				...
				void Cutter::doAllClose_Click()
				{
					...
					QString savecutsto = scriptName + ".clt";
				...
				void Cutter::sections_SelectedIndexChanged()
				{
				...
				void Cutter::InitializeComponent()
				{
					...
					this->updateZoneButton = new QPushButton;
					...
					this->doAllClose = new QPushButton;
					this->closeButton = new QPushButton;
					this->saveCuts = new QPushButton;
					this->addCutsToScript = new QPushButton;
