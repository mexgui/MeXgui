...
//C# TO C++ CONVERTER TODO TASK: There is no built-in support for multithreading in native C++:
				...
				void HdBdStreamExtractor::SetToolStripLabelText(const QString &message)
				{
//C# TO C++ CONVERTER TODO TASK: There is no built-in support for multithreading in native C++:
					lock (this)
					{
...
//C# TO C++ CONVERTER TODO TASK: There is no built-in support for multithreading in native C++:
				...
				void HdBdStreamExtractor::FolderInputSourceButton_Click()
				{
					QString myinput = "";
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'EndsWith' method:
				...
				void HdBdStreamExtractor::FolderOutputSourceButton_Click()
				{
					...
					DialogResult *dr = folderBrowserDialog1->show();
				...
				void HdBdStreamExtractor::FeatureButton_Click()
				{
					if (FolderInputTextBox->Text->empty())
					{
				...
				void HdBdStreamExtractor::StreamDataGridView_DataSourceChanged()
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'Split' method:
							QString *split = s->getDescription().Split(separator, 100);
				...
				void HdBdStreamExtractor::QueueButton_Click()
				{
					if (FolderOutputTextBox->Text->empty())
					{
					...
					// Load to MeXgui job queue
					if (FolderSelection->Checked)
					{
						const QString tempVector[] = {dummyInput};
						job = new HDStreamsExJob(QVector<QString>(tempVector, tempVector + sizeof(tempVector) / sizeof(tempVector[0])), this->FolderOutputTextBox->Text, args.getfeatureNumber(), args.getargs(), inputType);
					}
					else
				...
				const MeXgui::HDStreamsExJob &HdBdStreamExtractor::getLastJob() const
				{
					return lastJob;
				}
				...
				QString HdBdStreamExtractor::GenerateArguments()
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				...
				void HdBdStreamExtractor::CancelButton2_Click()
				{
					this->Close();
				}

				void HdBdStreamExtractor::HelpButton2_Click()
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				...
				void HdBdStreamExtractor::FeatureDataGridView_SelectionChanged()
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
						...
						else // backgroundworker is not busy, allow selection change
						{
							...
							{
								// create dummy input string for MeXgui job
								...
								{
									QString des = feature->getDescription().substr(feature->getDescription().find(",") + 2, feature->getDescription().rfind(",") - feature->getDescription().find(",") - 2);
				...
				void HdBdStreamExtractor::FeatureDataGridView_DataSourceChanged()
				{
					for (unknown::const_iterator row = FeatureDataGridView->Rows.begin(); row != FeatureDataGridView->Rows.end(); ++row)
					{
						...
						if (feature != 0)
						{
							...
							{
								for (QVector<File*>::const_iterator file = feature->getFiles().begin(); file != feature->getFiles().end(); ++file)
								{
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'Trim' method:
				...
				QString HdBdStreamExtractor::getBDMVPath(const QString &path, const QString &file)
				{
					QString filePath;
				...
				void HdBdStreamExtractor::InitializeComponent()
				{
					...
					this->HelpButton2 = new QPushButton;
					this->QueueButton = new QPushButton;
					this->CancelButton2 = new QPushButton;
					...
					this->FolderInputSourceButton = new QPushButton;
					this->Eac3toLinkLabel = new System::Windows::Forms::LinkLabel();
					this->FeatureGroupBox = new System::Windows::Forms::GroupBox();
					this->FeatureDataGridView = new MeXgui::packages::tools::hdbdextractor::CustomDataGridView();
					...
					this->StreamDataGridView = new MeXgui::packages::tools::hdbdextractor::CustomDataGridView();
					...
					this->FolderOutputSourceButton = new QPushButton;
					this->FolderOutputTextBox = new System::Windows::Forms::TextBox();
					this->openFileDialog1 = new System::Windows::Forms::OpenFileDialog();
					this->FeatureButton = new QPushButton;
					...
					this->Text = "MeXgui - HD-DVD/Blu-ray Streams Extractor";
