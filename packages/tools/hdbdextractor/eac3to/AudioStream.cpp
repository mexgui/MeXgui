...
namespace eac3to
{
	...
	const QString &AudioStream::getLanguage() const
	{
		return privateLanguage;
	}

	void AudioStream::setLanguage(const QString &value)
	{
		privateLanguage = value;
	}

	const QString &AudioStream::getChannels() const
	{
		return privateChannels;
	}

	void AudioStream::setChannels(const QString &value)
	{
		privateChannels = value;
	}

	const QString &AudioStream::getBitrate() const
	{
		return privateBitrate;
	}

	void AudioStream::setBitrate(const QString &value)
	{
		privateBitrate = value;
	}

	const QString &AudioStream::getDialogNormalization() const
	{
		return privateDialogNormalization;
	}

	void AudioStream::setDialogNormalization(const QString &value)
	{
		privateDialogNormalization = value;
	}

	const QString &AudioStream::getDelay() const
	{
		return privateDelay;
	}

	void AudioStream::setDelay(const QString &value)
	{
		privateDelay = value;
	}
	...
	AudioStream::AudioStream(const QString &s) : Stream(s)
	{
		if (s.empty())
	...
	Stream *AudioStream::Parse(const QString &s)
	{
