...
namespace MeXgui
{
	namespace packages
	{
		namespace video
		{
			namespace xvid
			{
				class xvidConfigurationPanel : public MeXgui::core::details::video::VideoConfigurationPanel, Editable<xvidSettings*>
				{
...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
				...
				private:
					...
					void xvidProfile_SelectedIndexChanged();

					void xvidVbvBuffer_TextChanged();

					void xvidVbvMaxRate_TextChanged();

					void xvidVbvPeakRate_TextChanged();
