	...
	namespace packages
	{
		namespace video
		{
			namespace xvid
			{
				...
				xvidConfigurationPanel::xvidConfigurationPanel() : MeXgui::core::details::video::VideoConfigurationPanel()
				{
					InitializeInstanceFields();
					InitializeComponent();
					cqmComboBox1->setStandardItems(new QString[] {xvidSettings::H263Matrix, xvidSettings::MPEGMatrix});
				}
				...
				QString xvidConfigurationPanel::getCommandline()
				{
				...
				MeXgui::VideoCodecSettings *xvidConfigurationPanel::defaultSettings()
				{
					return new xvidSettings();
				}

				const MeXgui::xvidSettings &xvidConfigurationPanel::getSettings() const
				{
				...
				void xvidConfigurationPanel::updateEvent()
				{
					genericUpdate();
				}
				...
				void xvidConfigurationPanel::logfileOpenButton_Click()
				{
				...
				void xvidConfigurationPanel::cqmComboBox1_SelectionChanged(object *sender, const QString &val)
				{
					genericUpdate();
				}

				void xvidConfigurationPanel::xvidProfile_SelectedIndexChanged()
				{
					genericUpdate();
				}

				void xvidConfigurationPanel::xvidVbvBuffer_TextChanged()
				{
					genericUpdate();
				}

				void xvidConfigurationPanel::xvidVbvMaxRate_TextChanged()
				{
					genericUpdate();
				}

				void xvidConfigurationPanel::xvidVbvPeakRate_TextChanged()
				{
					genericUpdate();
				}
...
//C# TO C++ CONVERTER WARNING: C# to C++ Converter converted the original 'null' assignment to a call to 'delete', but you should review memory allocation of all pointer variables in the converted code:
					...
					this->cqmComboBox1->SelectionChanged += new MeXgui::StringChanged(this, &xvidConfigurationPanel::cqmComboBox1_SelectionChanged);
					// 
