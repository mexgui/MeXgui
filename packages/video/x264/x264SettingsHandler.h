		...
		namespace video
		{
			namespace x264
			{
				...
				public:
					...
					int getSar(Nullable<Dar> d, int hRes, int vRes, QString &CustomSarValue, const QString &CustomSarValueInput);
				...
				private:
					bool extractCustomCommand(const QString &strCommandToExtract, QString &strCommandValue);
