	...
	namespace packages
	{
		namespace video
		{
			namespace x264
			{
				...
				x264ConfigurationPanel::x264ConfigurationPanel() : MeXgui::core::details::video::VideoConfigurationPanel()
				{
					InitializeInstanceFields();
					InitializeComponent();
					cqmComboBox1->setStandardItems(new QString[] {"Flat (none)", "JVT"});
				...
				QString x264ConfigurationPanel::getCommandline()
				{
				...
				MeXgui::VideoCodecSettings *x264ConfigurationPanel::defaultSettings()
				{
					return new x264Settings();
				}

				const MeXgui::x264Settings &x264ConfigurationPanel::getSettings() const
				{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				...
				void x264ConfigurationPanel::updateEvent()
				{
					genericUpdate();
				}
				...
				void x264ConfigurationPanel::logfileOpenButton_Click()
				{
					saveFileDialog->Filter = "x264 2pass stats files (*.stats)|*.stats";
					saveFileDialog->FilterIndex = 1;
					if (this->saveFileDialog->show() == DialogResult::OK)
					{
				...
				QString x264ConfigurationPanel::SelectHelpText(const QString &node)
				{
					StringBuilder *HelpText = new StringBuilder(64);

					QString xpath = "/ContextHelp/Codec[@name='x264']/" + node;
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				...
				void x264ConfigurationPanel::cqmComboBox1_SelectionChanged(object *sender, const QString &val)
				{
					genericUpdate();
				}
				...
				void x264ConfigurationPanel::cbAQMode_SelectedIndexChanged()
				{
					if (cbAQMode->SelectedIndex != 0)
				...
				void x264ConfigurationPanel::useQPFile_CheckedChanged()
				{
					qpfile->Enabled = useQPFile->Checked;
					qpfileOpenButton->Enabled = useQPFile->Checked;
				}

				void x264ConfigurationPanel::qpfileOpenButton_Click()
				{
					openFileDialog->Filter = "x264 QP Files (*.qpf, *.txt)|*.qpf;*.txt";
					openFileDialog->FilterIndex = 1;
					openFileDialog->FileName = "";
					if (this->openFileDialog->show() == DialogResult::OK)
					{
				...
				void x264ConfigurationPanel::tbx264Presets_Scroll()
				{
					switch (tbx264Presets->Value)
					{
						case 0:
				...
				void x264ConfigurationPanel::advancedSettings_CheckedChanged()
				{
				...
				void x264ConfigurationPanel::dSettings_Click()
				{
					// Main Tab
				...
				void x264ConfigurationPanel::btPresetSettings_Click()
				{
					doPresetsAdjustments();
					doTuningsAdjustments();
				}

				void x264ConfigurationPanel::x264Tunes_SelectedIndexChanged()
				{
					doTuningsAdjustments();
					genericUpdate();
				}

				void x264ConfigurationPanel::avcProfile_SelectedIndexChanged()
				{
					if (this->x264NumberOfBFrames->Value != x264Settings::GetDefaultNumberOfBFrames(static_cast<x264Settings::x264PresetLevelModes>(tbx264Presets->Value), getPsyTuning(), chkTuneZeroLatency->Checked, avcProfile->SelectedIndex, oTargetDevice, chkBlurayCompat->Checked))
						this->x264NumberOfBFrames->Value = x264Settings::GetDefaultNumberOfBFrames(static_cast<x264Settings::x264PresetLevelModes>(tbx264Presets->Value), getPsyTuning(), chkTuneZeroLatency->Checked, avcProfile->SelectedIndex, oTargetDevice, chkBlurayCompat->Checked);
					if (this->x264WeightedPPrediction->SelectedIndex != x264Settings::GetDefaultNumberOfWeightp(static_cast<x264Settings::x264PresetLevelModes>(tbx264Presets->Value), chkTuneFastDecode->Checked, avcProfile->SelectedIndex, chkBlurayCompat->Checked))
				...
				void x264ConfigurationPanel::cbTarget_SelectionChangeCommitted()
				{
				...
				void x264ConfigurationPanel::pictureBox1_Click()
				{
					VisitLink();
				}

				void x264ConfigurationPanel::targetDevice_SelectedIndexChanged()
				{
					oTargetDevice = x264DeviceList[0];
					for (QVector<x264Device*>::const_iterator oDevice = x264DeviceList.begin(); oDevice != x264DeviceList.end(); ++oDevice)
					{
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				...
				MeXgui::x264Settings::x264PsyTuningModes x264ConfigurationPanel::getPsyTuning()
				{
				...
				MeXgui::AVCLevels::Levels x264ConfigurationPanel::getAVCLevel()
				{
					EnumProxy *o = dynamic_cast<EnumProxy*>(avcLevel->SelectedItem);
					return static_cast<AVCLevels::Levels>(o->getRealValue());
				}

				void x264ConfigurationPanel::avcLevel_SelectedIndexChanged()
				{
				...
				void x264ConfigurationPanel::x264VBVBufferSize_ValueChanged()
				{
				...
				void x264ConfigurationPanel::x264VBVMaxRate_ValueChanged()
				{
				...
				void x264ConfigurationPanel::ch10BitsEncoder_CheckedChanged()
				{
					avcProfileGroupbox->Enabled = !ch10BitsEncoder->Checked;
					updateEvent(sender, e);
				}
				...
				void x264ConfigurationPanel::Dispose(bool disposing)
				{
					...
					MeXgui::core::details::video::VideoConfigurationPanel::Dispose(disposing);
				}
				...
				void x264ConfigurationPanel::InitializeComponent()
				{
					...
					this->cqmComboBox1 = new MeXgui::core::gui::FileSCBox();
					...
					this->btPresetSettings = new QPushButton;
					this->dSettings = new QPushButton;
					...
					this->logfileOpenButton = new QPushButton;
					this->qpfileOpenButton = new QPushButton;
					...
					this->cqmComboBox1->setType(MeXgui::core::gui::FileSCBox::Default);
					this->cqmComboBox1->SelectionChanged += new MeXgui::StringChanged(this, &x264ConfigurationPanel::cqmComboBox1_SelectionChanged);
					// 
					...
					// x264hrd
					// 
					this->x264hrd->AutoCompleteCustomSource->AddRange(new QString[3] {"None", "VBR", "CBR"});
				...
				void x264ConfigurationPanel::InitializeInstanceFields()
				{
					...
					x264DeviceList = QVector<x264Device*>();
					delete components;
				}
			}
		}
