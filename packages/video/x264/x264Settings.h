...
//[EnumTitle("SSIM")]
	...
	private:
		...
		QString quantizerMatrix, qpfile, openGop, range;
...
#warning Deprecated since 2327; delete after next stable release
		const QString &getx264Tuning() const;
		void setx264Tuning(const QString &value);
...
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[XmlIgnore(), MeXgui::core::plugins::interfaces::PropertyEqualityIgnoreAttribute()]
		...
		const QString &getTargetDeviceXML() const;
		void setTargetDeviceXML(const QString &value);
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[XmlIgnore()]
		...
		/// </summary>
		const QString &getBlurayCompatXML() const;
		void setBlurayCompatXML(const QString &value);
		...
		/// </summary>
		const QString &getOpenGop() const;
		void setOpenGop(const QString &value);
//C# TO C++ CONVERTER NOTE: The following .NET attribute has no direct equivalent in native C++:
//[XmlIgnore()]
		...
		const QString &getQPFile() const;
		void setQPFile(const QString &value);
		const QString &getRange() const;
