	...
	namespace packages
	{
		namespace video
		{
			namespace x264
			{
				...
				int x264SettingsHandler::getSar(Nullable<Dar> d, int hRes, int vRes, QString &CustomSarValue, const QString &CustomSarValueInput)
				{
					QString strCustomValue;
					CustomSarValue = "";
...
//ORIGINAL LINE: case "cbr":
				...
				MeXgui::AVCLevels::Levels x264SettingsHandler::getLevel()
				{
					QString strCustomValue;
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
				...
				MeXgui::x264Settings::x264InterlacedModes x264SettingsHandler::getInterlacedMode()
				{
					QString strCustomValue;
...
//ORIGINAL LINE: case "strict":
				...
				bool x264SettingsHandler::extractCustomCommand(const QString &strCommandToExtract, QString &strCommandValue)
				{
					QString strNewCommandLine = "";
					bool bFound = false;
					strCommandValue = "";
...
//C# TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the .NET String 'Trim' method:
				...
				QString x264SettingsHandler::getCustomCommandLine()
				{
