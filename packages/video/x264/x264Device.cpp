...
namespace MeXgui
{
	...
	QVector<x264Device*> x264Device::CreateDeviceList()
	{
		QVector<x264Device*> x264DeviceList = QVector<x264Device*>();
	...
	x264Device::x264Device(int iID, const QString &strName, int iProfile, AVCLevels::Levels avcLevel, int iVBVBufsize, int iVBVMaxrate, int iBframes, int iReframes, int iMaxWidth, int iMaxHeight)
	{
	}

	x264Device::x264Device(int iID, const QString &strName, int iProfile, AVCLevels::Levels avcLevel, int iVBVBufsize, int iVBVMaxrate, int iBframes, int iReframes, int iMaxWidth, int iMaxHeight, bool bBluRay, int iMaxGop, int iBPyramid)
	{
		this->iID = iID;
	...
	const QString &x264Device::getName() const
	{
		return strName;
	}
