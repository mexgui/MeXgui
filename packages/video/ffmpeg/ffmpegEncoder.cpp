...
JobProcessorFactory *const ffmpegEncoder::Factory = new JobProcessorFactory(new ProcessorFactory(&init), "FFmpegEncoder");
	...
	ffmpegEncoder::ffmpegEncoder(const QString &encoderPath) : CommandlineVideoEncoder()
	{
			executable = encoderPath;
	}

	const QString &ffmpegEncoder::getCommandline() const
	{
...
//C# TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'ToString':
	...
	void ffmpegEncoder::ProcessLine(const QString &line, StreamType stream, ImageType oType)
	{
