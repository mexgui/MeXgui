	...
	namespace packages
	{
		namespace audio
		{
			namespace opus
			{
				...
				OpusConfigurationPanel::OpusConfigurationPanel() : MeXgui::core::details::audio::AudioConfigurationPanel()
				{
				...
				const MeXgui::AudioCodecSettings &OpusConfigurationPanel::getCodecSettings() const
				{
				...
				const MeXgui::OpusSettings &OpusConfigurationPanel::getSettings() const
				{
				...
				void OpusConfigurationPanel::trackBar_ValueChanged()
				{
					switch (cbMode->SelectedIndex)
					{
						case 0: // VBR
							encoderGroupBox->Text = QString::Format("OPUS Options - Variable Bitrate @ {0} kbit/s", trackBar->Value);
							break;
						case 1: // CVBR
							encoderGroupBox->Text = QString::Format("OPUS Options - Constrained Variable Bitrate @ {0} kbit/s", trackBar->Value);
							break;
						case 2: // CBR
							encoderGroupBox->Text = QString::Format("OPUS Options - Hard Constant Bitrate  @ {0} kbit/s", trackBar->Value);
							break;
					}
				}
