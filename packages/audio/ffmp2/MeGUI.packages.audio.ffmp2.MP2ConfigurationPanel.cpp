	...
	namespace packages
	{
		namespace audio
		{
			namespace ffmp2
			{
				...
				MP2ConfigurationPanel::MP2ConfigurationPanel() : MeXgui::core::details::audio::AudioConfigurationPanel()
				{
				...
				const MeXgui::AudioCodecSettings &MP2ConfigurationPanel::getCodecSettings() const
				{
				...
				const MeXgui::MP2Settings &MP2ConfigurationPanel::getSettings() const
				{
