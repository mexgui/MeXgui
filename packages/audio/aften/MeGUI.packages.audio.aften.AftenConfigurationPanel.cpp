	...
	namespace packages
	{
		namespace audio
		{
			namespace aften
			{
				...
				AftenConfigurationPanel::AftenConfigurationPanel() : MeXgui::core::details::audio::AudioConfigurationPanel()
				{
				...
				const MeXgui::AudioCodecSettings &AftenConfigurationPanel::getCodecSettings() const
				{
				...
				const MeXgui::AftenSettings &AftenConfigurationPanel::getSettings() const
				{
