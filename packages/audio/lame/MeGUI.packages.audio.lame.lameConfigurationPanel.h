...
namespace MeXgui
{
	namespace packages
	{
		namespace audio
		{
			namespace lame
			{
				class lameConfigurationPanel : public MeXgui::core::details::audio::AudioConfigurationPanel, Editable<MP3Settings*>
				{
					public:
...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
				...
				private:
					...
					void cbrMode_CheckedChanged();

					void abrMode_CheckedChanged();

					void vbrMode_CheckedChanged();
