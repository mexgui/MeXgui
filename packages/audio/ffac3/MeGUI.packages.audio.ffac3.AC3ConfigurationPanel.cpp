	...
	namespace packages
	{
		namespace audio
		{
			namespace ffac3
			{
				...
				AC3ConfigurationPanel::AC3ConfigurationPanel() : MeXgui::core::details::audio::AudioConfigurationPanel()
				{
				...
				const MeXgui::AudioCodecSettings &AC3ConfigurationPanel::getCodecSettings() const
				{
				...
				const MeXgui::AC3Settings &AC3ConfigurationPanel::getSettings() const
				{
