...
namespace MeXgui
{
	namespace packages
	{
		namespace audio
		{
			namespace ffac3
			{
				class AC3ConfigurationPanel : public MeXgui::core::details::audio::AudioConfigurationPanel, Editable<AC3Settings*>
				{
					public:
...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
				...
				private:
					const AC3Settings &getSettings() = Editable::Settings::get const;
					void setSettings(const AC3Settings &value) = Editable::Settings::set;
