	...
	namespace core
	{
		namespace details
		{
			namespace audio
			{
				...
				const MeXgui::AudioCodecSettings &AudioConfigurationPanel::getCodecSettings() const
				{
				...
				const MeXgui::AudioCodecSettings &AudioConfigurationPanel::getSettings() const
				{
				...
				void AudioConfigurationPanel::besweetDelay_TextChanged()
				{
				}

				void AudioConfigurationPanel::applyDRC_CheckedChanged()
				{
					autoGain->Checked = applyDRC->Checked;
					autoGain_CheckedChanged(sender, e);
				}

				void AudioConfigurationPanel::autoGain_CheckedChanged()
				{
