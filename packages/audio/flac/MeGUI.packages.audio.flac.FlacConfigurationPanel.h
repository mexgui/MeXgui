...
namespace MeXgui
{
	namespace packages
	{
		namespace audio
		{
			namespace flac
			{
				class FlacConfigurationPanel : public MeXgui::core::details::audio::AudioConfigurationPanel, Editable<FlacSettings*>
				{
				   public:
...
//C# TO C++ CONVERTER WARNING: Unlike C#, there is no automatic call to this finalizer method in native C++:
			   ...
			   public:
				...
				private:
					const FlacSettings &getSettings() = Editable::Settings::get const;
					void setSettings(const FlacSettings &value) = Editable::Settings::set;
					...
					System::Windows::Forms::TrackBar *tbQuality;
